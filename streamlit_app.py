...
# 4. UI: INPUTS
# ==========================================
c_tick, c_space, c_pdf = st.columns([.50, 5, 0.45], vertical_alignment="bottom")
...
c_title, c_space, c_toggle, c_reset = st.columns([6, 2, 1, 1.5], vertical_alignment="bottom")
...
with c_g:
    ...
    # >>> CONTROLS THE VERTICAL GAP (Change 30px to adjust) <<<
