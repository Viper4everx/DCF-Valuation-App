...
with st.sidebar:
    ...
    # If Margin > 30% (Tech/Software) -> Higher Growth/Multiple
    if current_margin > 0.30:
        def_growth = 15.0
        def_mult = 25.0
    # If Margin < 10% (Retail/Commodity) -> Lower Growth/Multiple
    ...
    # Key={ticker} ensures inputs reset when you change companies
